...
#=============================================================
    ...
    def show_process(self, axes):
        ...
        first_x_text = TextMobject(
            "First the $x$ integration..", color=YELLOW
        )
        ...
        then_y_text = TextMobject(
            "Then the $y$ integration..", color=YELLOW
        )
        ...
        self.play(
            Write(VGroup(graph, plane, x_func)), run_time=3
        )
    ...
    def get_y_slice_graph(self, axes, func, y, **kwargs):
        ...
        slice_curve = ParametricFunction(
            lambda x: axes.c2p(x, y, func(x, y)),
            **config,
        )
        return slice_curve
